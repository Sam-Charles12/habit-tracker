    ...
    <main className="flex-grow bg-zinc-950 text-zinc-100 p-4 pt-16 md:p-8 md:pt-16 min-h-screen relative pb-24">
      <div className="max-w-xl mx-auto">
        ...
        <header className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-semibold tracking-tight">{greeting}, {user.email.split("@")[0]}</h1>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="w-12 h-12 rounded-full bg-zinc-800 flex items-center justify-center border-2 border-zinc-700 overflow-hidden">
              <span className="text-lg font-bold text-emerald-400">{user.email.charAt(0).toUpperCase()}</span>
            </div>
          </div>
        </header>
...
function EditHabitModal({ habit, onClose, onSave }: { habit: Habit; onClose: () => void; onSave: (name: string) => void }) {
